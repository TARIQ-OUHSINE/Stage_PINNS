...
# ==============================================================================
# SECTION 2: MOTEUR D'ENTRAÎNEMENT PAR MINI-BATCHS
# ==============================================================================
...
def run_original_batch(params_pinns: dict, params: dict, S_f: DataAugmentation, S_j: DataAugmentation, output_path: Path):
    # === MODIFIÉ POUR L'ENTRAÎNEMENT PAR MINI-BATCHS ===
    ...
    # Points pour la physique (Fick), sur grille fixe
    nb_r_total = 500
    nb_t_total = 500
    ...
    # Points pour les données (bord et initial), sur grille fixe
    ...
    # --- Boucle d'entraînement par Mini-Batchs ---
    for it in tqdm(range(params_pinns["epoch"]), desc="Entraînement par Batchs"):
        ...
        # Sauvegarde de l'historique (toutes les 10 itérations)
        if it % 10 == 0:
...
if __name__ == "__main__":
    # --- CONFIGURATION ---
    EXP_NAME_TO_RUN = "LongTime_60_60_300_2500" 
    CASE = "On"
    params_pinns = {
        "nb_hidden_layer": 2,
    ...
    base_output = code_dir / "output" / "runs_fidele_original_batch"
