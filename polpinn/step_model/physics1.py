...
# Pas de changement dans l'initialisation
class FickResidual:
    ...
    def __call__(self, X, *args: Any, **kwds: Any) -> Any:
        ...
        # On utilise .apply() pour évaluer les fonctions customisées
        D_tensor = self.D.apply(r)
        P0_tensor = self.P0.apply(r)
        T_tensor = self.T.apply(r)
        # --- FIN DE LA CORRECTION ---

        # Ce calcul de gradient est complexe, il nécessite que D_tensor soit un Tensor,
